...
public class TSL2561 extends I2C {
    ...
    /**
     * Set the time response to slowest possible of 402ms between send command and read data. That's
     * the default settings after powered on.
     * 
     * @throws IOException on communication error
     */
    ...
    /**
     * Set the gain (precision) of read data to 1x. That's the default settings after powered on.
     * 
     * @throws IOException on communication error
     */
