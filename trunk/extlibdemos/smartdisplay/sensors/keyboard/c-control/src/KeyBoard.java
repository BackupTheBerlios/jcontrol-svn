...
import jcontrol.san.driver.i2c.key.PCF8574TKeyBoard;

/**
 * Demo for the Conrad keyboard with PCF8574T (Philips) using the SM (I<sup>2</sup>C) bus.
 * 
...
public class KeyBoard {
    ...
    public static void main(String[] args) {
        ...
        PCF8574TKeyBoard keyboard = new PCF8574TKeyBoard(0x40);
