 ...
 * @see <a href="doc-files/crx14_article.pdf">crx14 german article (Elektronik Informationen Nr.
 *      10-2004)</a>
...
public class CRX14Reader extends I2C implements RFIDReader {
    ...
    public boolean select(RFIDTransponder transponder) throws IOException {
        ...
        if (((data[1] & 0xff) % 16) != transponder.getChipId()) { return false; }
        return true;
    }
