...
/**
 * Temperature sensor TMP75 (Texas Instruments) using the SM (I<sup>2</sup>C)
 * bus.
 * <p>
 * The TMP75 is a temperature sensor with a SM (I<sup>2</sup>C) interface. The
 * temperature range goes from -40&deg;C to 125&deg;C. The chip have a
 * resolution between 9 and 12 bits and a LSB unit from 0,0625&deg;C.
 * </p>
 * <p>
