...
public class PCF8563Demo extends Frame {
    ...
    public void onActionEvent(ActionEvent e) {
        if (e.getType() == ActionEvent.BUTTON_PRESSED) {
            ...
            if (e.getSource() == changeButton) {
                ...
                try {
                    my8563.setTime(new Time(yearChange.getValue(), monthChange.getValue(),
                            dayChange.getValue(), 0, hourChange.getValue(),
                            minuteChange.getValue(), secondChange.getValue()));
                } catch (IOException ex) {
                }
    ...
    void mainMenu() {
        ...
        month = new Label((months < 10 ? "0" : "").concat(String.valueOf(months)).concat("."), 15,
                15);
    ...
    class TimeRequester extends Thread {
        public void run() {
            ...
            for (; !modify;) {
                ...
                if (months != t.month) {
                    months = t.month;
                    month.setLabel((months < 10 ? "0" : "").concat(String.valueOf(months)).concat(
                            "."), false);
                }
                if (days != t.day) {
                    days = t.day;
                    day.setLabel((days < 10 ? "0" : "").concat(String.valueOf(days)).concat("."),
                            false);
                }
