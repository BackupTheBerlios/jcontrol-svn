...
public class LM75 extends I2C {
     ...
     *               {@Choice value="0x90" text="0x90"} {@Choice value="0x92" text="0x92"}
     *               {@Choice value="0x94" text="0x94"} {@Choice value="0x96" text="0x96"}
     *               {@Choice value="0x98" text="0x98"} {@Choice value="0x9a" text="0x9a"}
     *               {@Choice value="0x9c" text="0x9c"} {@Choice value="0x9e" text="0x9e"} }
     */
